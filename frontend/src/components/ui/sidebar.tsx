...
function Sidebar({
    ...
    if (isMobile) {
        return (
            <Drawer.Root direction="left" open={openMobile} onOpenChange={setOpenMobile}>
                <Drawer.Portal>
                    <Drawer.Overlay className="fixed inset-0 z-50 bg-black/50" />
                    <Drawer.Content
                        data-sidebar="sidebar"
                        data-slot="sidebar"
                        className="bg-sidebar text-sidebar-foreground fixed inset-y-0 left-0 z-50 flex h-full w-[--sidebar-width] flex-col p-0"
    ...
    return (
        <button
            ...
            className={cn(
                ...
                "group-data-[side=left][data-collapsible=offcanvas]:-right-2 group-data-[side=right][data-collapsible=offcanvas]:-left-2",
                className
            )}
            {...props}
        />
...
function SidebarInput({ className, ...props }: React.ComponentProps<"input">) {
    return (
        <input
            ...
            data-sidebar="input"
            className={cn(
                "bg-background focus-visible:ring-sidebar-ring h-8 w-full rounded-md border-none px-2 text-sm shadow-none focus-visible:ring-2",
                className
            )}
            {...props}
        />
...
function SidebarMenuSkeleton({
    ...
    return (
        <div
            ...
            {...props}
        >
            {showIcon && <div className="bg-sidebar-accent size-4 rounded-md" data-sidebar="menu-skeleton-icon" />}
            <div
